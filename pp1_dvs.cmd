...
(sdegeo:create-rectangle (position -0.00827 0.105 0.0) (position 0.0 0.145 0.0) "Oxide" "R.GateOx")
(sdegeo:create-rectangle (position -0.070 0.105 0.0) (position -0.00827 0.145 0.0) "PolySilicon" "R.Poly")
...
(sdedr:define-refinement-size "Gate_Ref_Def"0.002 0.004 0 0.001 0.001 0)
...
(sdedr:define-refinement-function "Gate_Ref_Def" "MaxLenInt" "Silicon" "Oxide"
0.0003 1.4 "DoubleSide")
